        ...
        <Table hoverable>
          ...
          <Table.Body className="divide-y">
            ...
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell>0977702769</Table.Cell>
              <Table.Cell>
              <button className="bg-transparent text-[#000054] text-sm px-2 font-bold border border-[#000054] rounded-lg">Shipping</button>
              </Table.Cell>
              <Table.Cell>
            ...
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell>0977702769</Table.Cell>
              <Table.Cell>
                <button className="bg-transparent text-[#618264] text-sm px-5 font-bold border border-[#618264] rounded-lg">To ship</button>
              </Table.Cell>
              <Table.Cell>
