...
export default function OrderSummary({ checkoutInfo, price, products }) {
  ...
  const postData = async () => {
    try {
      ...
      const res = await axios.post("https://building-it-system-server.vercel.app/checkout", { checkoutInfo: checkoutInfo, products: products, shippingFee: shippingFee }, { withCredentials: true });
