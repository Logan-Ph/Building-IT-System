...
import MoreDetailOrder from './ShipperMoreDetailOrder';
                    ...
                    {foundOrder && foundOrder.map(order => {
                        ...
                        return (
                            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <Table.Cell>
                                    <button className="bg-transparent text-[#E61E2A] text-sm px-2 font-bold border border-[#E61E2A] rounded-lg">Accepted</button>
                                </Table.Cell>
                                <Table.Cell>
                    ...
                    {!foundOrder && orders.map((order) => {
                        ...
                        return (
                            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <Table.Cell>{order.contactNumber}</Table.Cell>
                                <Table.Cell>
                                    <button className="bg-transparent text-blue-600 text-sm px-2 font-bold border border-blue-600 rounded-lg">Accept</button>
                                </Table.Cell>
                                <Table.Cell>
                                    <MoreDetailOrder order={order} />
                                </Table.Cell>
