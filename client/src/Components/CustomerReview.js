                      ...
                      return (
                        <>
                          <div class="flex flex-row pt-1 md-10 md:ml-16 mt-2 xs:pt-0 xs:mt-0  xs:px-2">
                            {reply.userImg || reply.vendorImg ? <img className="inline-block xl:w-10 xl:h-10 lg:w-10 lg:h-10 md:w-8 md:h-8 sm:w-8 sm:h-8 xs:w-5 xs:h-5 rounded-full object-fit ring-2 ring-white"
