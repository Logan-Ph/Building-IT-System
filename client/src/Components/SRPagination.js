...
export default function Example() {
  ...
  return (
    <div className="flex items-center px-4 py-3 sm:px-6 mt-5">
      <div className="xs:flex xs:flex-1 xs:justify-end sm:flex sm:flex-1 sm:items-center sm:justify-between lg:justify-end">
        <div>
