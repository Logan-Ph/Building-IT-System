...
export default function Chatbot() {
  ...
  const handleResponse = async (message) => {
    const res = await axios.post('https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/api/chatbot/message', { message: message }, { withCredentials: true });
