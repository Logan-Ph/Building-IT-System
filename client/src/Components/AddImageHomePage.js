export default function AddImageHomePage() {
    return (
        <>
            ...
            <div class="mx-auto">
                <h2 class="mb-4 text-2xl tracking-tight font-bold text-gray-900">Upload Banners in Homepage</h2>
                <label for="cover-photo" class="block text-lg font-bold leading-6 text-gray-900">Carousel Images</label>
