export default function VandorNav() {
    return (
      <>
        {/* Profile Section */}
          ...
          <div class="md:flex my-3 md:justify-between px-4 md:px-0">
            <div class="flex items-center gap-4">
              ...
              <div class="font-medium">
                <div class="text-2xl">Jellycat</div>
          ...
          <div class="px-4 py-2 mx-auto md:flex md:justify-between">
              ...
              <form>
                <div class="relative">
                  ...
                  <input
                    ...
                    placeholder="Search in Jellycat"
                  />
                </div>
              </form>
            </div>
            ...
            <div class="flex items-center">
              <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm py-3">
                <li class="border-b-2 px-2 py-3 hover:border-black duration-700 transition">
                  <a
                    href="#"
                ...
                <li class="border-b-2 border-transparent px-2 py-3 hover:border-black duration-700 transition">
                  <a
                    href="#"
                ...
                <li class="border-b-2 border-transparent px-2 py-3 hover:border-black duration-700 transition">
                  <button
                    ...
                    class="flex items-center justify-between text-gray-900hover:underline text-sm md:text-lg font-light"
                  >
                    CATEGORIES
                    <svg
                  ...
                  <div
                    id="dropdownNavbar"
                    class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44"
                  >
                    <ul
