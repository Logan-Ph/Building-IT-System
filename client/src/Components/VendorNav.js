...
export default function VandorNav({ user, vendor, activeTab, coverPhoto, numberOfFollowers, numberOfProducts, setFollow, follow }) {
  ...
  async function reportProduct() {
    try {
      ...
      await axios.post('https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/report-vendor', fd, { withCredentials: true })
        .then(res => {
          setError('')
          setMsg(res.data)
          setLoading(false)
  ...
  const fetchData = useCallback(async () => {
    try {
      await axios.get(`https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/check-follow/${vendor._id}/${user._id}`, { withCredentials: true })
        .then(res => {
  ...
  const handleUnfollow = async () => {
    ...
    try {
      await axios.post("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/unfollow-vendor", data, { withCredentials: true })
        .then(res => {
          setFollow(res.data.following);
        })
    } catch (error) {
  ...
  const handleFollow = async () => {
    ...
    try {
      await axios.post("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/follow-vendor", data, { withCredentials: true })
        .then(res => {
          setFollow(res.data.following);
        })
    } catch (error) {
  ...
  const createThread = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/chat", { vendorId: vendor._id }, { withCredentials: true });
