      ...
      <Table hoverable>
        ...
        <Table.Body className="divide-y">
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <Table.Cell>
              <button className="bg-transparent text-[#E61E2A] text-sm px-2 font-bold border border-[#E61E2A] rounded-lg">Not Confirm</button>
            </Table.Cell>
            <Table.Cell>
        ...
        <div className='space-y-6'>
          ...
          <div className="flex">
            ...
            <div>
              <div className='ml-10'>
                <p className="text-md leading-relaxed text-gray-900 line-clamp-1">
                  Phấn má hồng ngọt ngào dạng nén Romand Better Than Cheek123123123
                </p>
              </div>
              <div className='my-2 ml-10 flex justify-between'>
                <p className="text-sm leading-relaxed text-gray-500">
      ...
      <Modal.Footer>
        <div className='flex items-center justify-between w-full'>
          ...
          <div className='flex items-center'>
            ...
            <button className="ml-2 bg-transparent text-[#E61E2A] text-sm px-2 font-bold border border-[#E61E2A] rounded-lg">Not Confirm</button>
          </div>
        </div>
