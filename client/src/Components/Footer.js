                ...
                <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                  <div>
                    ...
                    <nav className="flex flex-col mt-4 space-y-2 text-sm text-white">
                      ...
                      <a className="hover:opacity-75" href> rBuy Careers </a>
                      <a className="hover:opacity-75" href> rBuy Policies </a>
                  ...
                  <div>
                    ...
                    <nav className="flex flex-col mt-4 space-y-2 text-sm text-white">
                      ...
                      <a className="hover:opacity-75" href> Order Review </a>
                      <a className="hover:opacity-75" href> Accounts Review </a>
                      <a className="hover:opacity-75" href> Delivery </a>
                      <a className="hover:opacity-75" href> Return and Refund </a>
                    </nav>
                  </div>
                  <div>
                    <p className="font-bold text-white">
                    ...
                    <nav className="flex flex-col mt-4 space-y-2 text-sm text-white">
                      ...
                      <a className="hover:opacity-75" href> Customer Services </a>
                    </nav>
                  </div>
                  <div>
                    <p className="font-bold text-white">
