...
export default function ProductDetailComment({ product }) {
    ...
    const postComment = async () => {
        try {
            const res = await axios.post(`https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/product/${product._id}/post-comment`, { newComment: newComment, title: title }, { withCredentials: true });
