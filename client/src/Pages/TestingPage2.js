...
<div className="bg-white">
  <div>
    ...
    <div className="relative z-40 lg:hidden transition-opacity-100 ease-linear duration-300" role="dialog" aria-modal="true">
     
      <div className="fixed inset-0 bg-black bg-opacity-25 transition ease-in-out duration-300 transform"></div>
      ...
      <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
        ...
        <div className="flex items-center">
          <div className="relative inline-block text-left">
              ...
              <select  className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true">
                Sort
                
             
             <option href="#" className="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Most Popular</option>
             <option href="#" className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Best Rating</option>
             <option href="#" className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Newest</option>
             <option href="#" className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-3">Price: Low to High</option>
             <option href="#" className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-4">Price: High to Low</option>
