                ...
                <div className="flex flex-col pb-32 w-full "> 
                    <div className="my-6 ">
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mx-auto ">
                            ...
                            <div className="border border-[#FAC800] rounded-md px-2 py-3 flex  items-center gap-8 shadow-lg shadow-gray-100 bg-[#FAC800]">
                                <img src={require("../Components/images/logo1.png")} className="w-12 h-12 object-contain" />
                                <div>
                    ...
                    <h2 className="col-span-full text-center md:text-2xl text-3xl font-bold text-[#000054] my-6">Trending Products</h2>
                    ...
                    <button type="button" className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-8 mb-8 flex justify-center mx-auto">
                        Explore more
                    </button>  

                    <h2 className="col-span-full text-center md:text-2xl text-3xl font-bold text-[#000054] my-6">On Sale Products</h2>
                    <div className="grid grid-cols-6 md:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1  items-center gap-y-16 md:gap-y-14 lg:gap-x-10 sm:gap-x-5 md:gap-x-20 gap-x-10 px-0 sm:px-20 md:px-0 lg:px-0 my-4 mb-5 md:max-w-2xl lg:max-w-7xl">

                        <div className="bg-white overflow-hidden group rounded-lg shadow-lg dark:border-gray-700 group">
                            <div className="relative">
                                <div className="w-full h-[162px]">
                                    <img src={require("../Components/images/chair.jpg")} className="object-cover"/>
                                </div>
                                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition">
                                    <a href="" className="text-white text-xl w-9 h-8 rounded-full bg-red-500 flex items-center justify-center hover:bg-red-800 transition p-2">
                                        <i className="fa-solid fa-magnifying-glass"></i>
