                ...
                <div className="flex flex-col justify-around pb-32 w-full ">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 sm:gap-y-4 mx-auto">
                            <div className="border border-[#FAC800] rounded-md px-2 py-3 flex items-center justify-around shadow-lg shadow-gray-100 hover:bg-[#fac800e1] w-3/4 transition">
                                <div className="w-12 h-12">
                                    <img src={require("../Components/images/free.png")} alt='' className="object-cover" />
                                </div>
                            ...
                            <div className="border border-[#FAC800] rounded-md px-2 py-3 flex  items-center justify-around shadow-lg shadow-gray-100  hover:bg-[#fac800e1] transition w-3/4">
                                <img src={require("../Components/images/save-money.png")} alt='' className="w-12 h-12 object-contain" />
                                <div>
                            ...
                            <div className="border border-[#FAC800] rounded-md px-2 py-3 flex items-center justify-around shadow-lg shadow-gray-100 hover:bg-[#fac800e1] transition w-3/4">
                                <div className='w-12 h-12'>
                                    <img src={require("../Components/images/credit-card.png")} alt='' className="object-contain" />
                                </div>
                                <div>
                            ...
                            <div className="border border-[#FAC800] rounded-md px-2 py-3 flex  items-center justify-around shadow-lg shadow-gray-100 hover:bg-[#fac800e1] transition w-3/4">
                                <div className='w-12 h-12'>
                                    <img src={require("../Components/images/delivery.png")} alt='' className=" object-contain" />
                                </div>
                                <div>
                    ...
                    <div className="flex flex-row items-center my-6">
                        <div className='w-8 h-8'>
                            <img src={require("../Components/images/trending.png")} alt='' className="object-cover" />
                        </div>
                    ...
                    <div className="grid grid-cols-6 md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2  gap-y-16 md:gap-y-14 lg:gap-x-10 sm:gap-x-0 md:gap-x-4 gap-x-0 px-0 sm:px-0 md:px-0 lg:px-0 my-4 mb-5 md:max-w-2xl lg:max-w-7xl items-center">
