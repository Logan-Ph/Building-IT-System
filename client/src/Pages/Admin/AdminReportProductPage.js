...
export default function ReportedProductPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const res = await axios.get(`https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/admin/manage-vendor-product/${params.id}`, { withCredentials: true });
      setIsLoading(false)
