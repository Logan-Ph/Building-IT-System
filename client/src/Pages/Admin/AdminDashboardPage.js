...
export default function DashboardPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const res = await axios.get("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/admin/dashboard", {
  ...
  const fetchImages = async () => {
    try {
      await axios.get("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/slider", { withCredentials: true })
      .then (res => setBigImages(res.data.images))
      await axios.get("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/middle-banner", { withCredentials: true }).then (res => setSmallImages(res.data.images))
    } catch (error) {
