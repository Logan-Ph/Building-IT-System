            ...
            <div className="h-80 ">
              <Carousel>
                <div>
                  ...
                  <div id="image-preview" class="max-w-full h-64 p-6 mb-4 bg-gray-100 border-dashed border-2 border-gray-400 rounded-lg items-center mx-auto text-center cursor-pointer object-fit">

                    <input id="upload" type="file" class="hidden" accept="image/*" required />
