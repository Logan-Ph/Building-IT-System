...
<Rating className="mb-2 ">
    ...
    <div class="mb-2 text-sm text-gray-500 "><p>Reviewed in the United Kingdom on <time datetime="2017-03-03 19:00">March 3, 2017</time></p></div>
    <p class="flex-1  text-sm font-medium leading-loose text-gray-600">This is my third Invicta Pro Diver. They are just fantastic value for money. This one arrived yesterday and the first thing I did was set the time, popped on an identical strap from another Invicta and went in the shower with it to test the waterproofing.... No problems.</p>
