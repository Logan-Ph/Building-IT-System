...
export default function Homepage() {
    ...
    const fetchProduct = useCallback(async () => {
        try {
            const res = await axios.get("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/", { withCredentials: true });
...
function MiddleBanner({ setNavigateTo }) {
    ...
    const fetchImages = async () => {
        try {
            const response = await axios.get("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/middle-banner", { withCredentials: true });
