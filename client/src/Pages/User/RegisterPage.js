        ...
        try {
            switch (formType) {
                case 'customer':
                    ...
                    await axios.post('https://building-it-system-frontend.vercel.app/user-register', data, { withCredentials: true })
                        .then(res => {
                            setMsg(res.data)
                            setError('')
                        })
                ...
                case 'business':
                    ...
                    await axios.post('https://building-it-system-frontend.vercel.app/vendor-register', data, { withCredentials: true })
                        .then(res => {
                            setMsg(res.data)
                            setError('')
                        })
                ...
                case 'shipper':
                    ...
                    await axios.post('https://building-it-system-frontend.vercel.app/shipper-register', data, { withCredentials: true })
                        .then(res => {
                            setMsg(res.data)
