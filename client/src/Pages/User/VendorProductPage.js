...
export default function VendorProductPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const res = await axios.get(
        `https://building-it-system-server.vercel.app/vendor/${params.id}/product`,
  ...
  }, [fetchData, refine, vendor?.businessName, isLoading]);
    ...
    <>
      ...
      <section>
        ...
        <VendorNav
          ...
          setNumberOfFollwers={setNumberOfFollowers}
          follow={follow}
          setFollow={setFollow}
        />
