...
export default function LogInPage() {
    ...
    const axiosPostData = async () => {
        ...
        await axios.post('https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/login', postData, { withCredentials: true })
    ...
    const googleLogin = async () => {
        const loginWindow = window.open("https://building-it-system-server-ppt2mxwor-logan-phs-projects.vercel.app/auth/google", "_blank");
