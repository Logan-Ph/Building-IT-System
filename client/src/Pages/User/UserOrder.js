          ...
          <>
            <div class="my-4 md:mt-6 flex flex-col">
              <div class="p-6 bg-white divide-y">
                <div className="flex-col items-center justify-between w-full mb-4 ">
                  <div className="inline-flex items-center">
                    ...
                    <button class="pl-2 md:mr-2 text-lg font-bold">
                      {data.vendorName + "  "}
                    </button>
                  </div>
